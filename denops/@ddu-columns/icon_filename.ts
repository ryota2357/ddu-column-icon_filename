...
import { ambiwidth } from "https://deno.land/x/denops_std@v3.9.1/option/mod.ts";
import { basename, extname } from "https://deno.land/std@0.162.0/path/mod.ts";
...
const specialIcons = new Map<string, IconData>([                                               // nerd font class name
  [".ds_store",          { icon: "", hl_group: "sp_ds_store",    color: palette.normal     }], // nf-dev-aptana
  [".gitignore",         { icon: "", hl_group: "sp_gitignore",   color: palette.darkOrange }], // nf-dev-git
  [".gitconfig",         { icon: "", hl_group: "sp_gitconfig",   color: palette.normal     }], // nf-dev-aptana
  [".gitlab-ci.yml",     { icon: "", hl_group: "sp_gitlab_ci",   color: palette.normal     }], // nf-fa-gitlab
  ["config.ru",          { icon: "", hl_group: "sp_config_ru",   color: palette.normal     }], // nf-dev-ruby
  ...
  ["makefile",           { icon: "", hl_group: "sp_gitconfig",   color: palette.normal     }], // nf-dev-aptana
  ["license",            { icon: "", hl_group: "sp_license",     color: palette.normal     }], // nf-seti-license
  ["license.txt",        { icon: "", hl_group: "sp_license",     color: palette.normal     }], // nf-seti-license
...
const fileIcons = new Map<string, IconData>([                                    // nerd font class name
  ...
  ["awk",    { icon: "", hl_group: "file_awk",    color: palette.normal      }], // nf-dev-terminal
  ["bash",   { icon: "", hl_group: "file_bash",   color: palette.normal      }], // nf-dev-terminal
  ["bat",    { icon: "", hl_group: "file_bat",    color: palette.normal      }], // nf-dev-aptana
  ...
  ["conf",   { icon: "", hl_group: "file_conf",   color: palette.normal      }], // nf-dev-aptana
  ...
  ["csh",    { icon: "", hl_group: "file_csh",    color: palette.normal      }], // nf-dev-terminal
  ...
  ["elm",    { icon: "", hl_group: "file_elm",    color: palette.normal      }], // nf-dev-dart
  ...
  ["gz",     { icon: "", hl_group: "file_gz",     color: palette.normal      }], // nf-oct-file_zip
  ["h",      { icon: "", hl_group: "file_h",      color: palette.normal      }], // nf-fa-h_square
  ["hpp",    { icon: "", hl_group: "file_hpp",    color: palette.normal      }], // nf-fa-h_square
  ...
  ["pp",     { icon: "", hl_group: "file_pp",     color: palette.normal      }], // nf-oct-beaker
  ...
  ["sass",   { icon: "", hl_group: "file_sass",   color: palette.normal      }], // nf-dev-sass
  ...
  ["tex",    { icon: "", hl_group: "file_tex",    color: palette.normal      }], // nf-mdi-text_shadow
  ["toml",   { icon: "", hl_group: "file_toml",   color: palette.normal      }], // nf-dev-aptana
  ["ts",     { icon: "", hl_group: "file_ts",     color: palette.blue        }], // nf-seti-typescript
  ["tsx",    { icon: "", hl_group: "file_tsx",    color: palette.blue        }], // nf-dev-react
  ["txt",    { icon: "", hl_group: "file_txt",    color: palette.normal      }], // nf-seti-text
  ...
  ["yaml",   { icon: "", hl_group: "file_yaml",   color: palette.normal      }], // nf-dev-aptana
  ["yml",    { icon: "", hl_group: "file_yml",    color: palette.normal      }], // nf-dev-aptana
  ["zip",    { icon: "", hl_group: "file_zip",    color: palette.normal      }], // nf-oct-file_zip
  ["zsh",    { icon: "", hl_group: "file_zsh",    color: palette.normal      }], // nf-dev-terminal
]);
// deno-fmt-ignore-end
